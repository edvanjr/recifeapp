...
import { InfoFeirasPage } from '../info-feiras/info-feiras';
...
export class FeirasPage {
  ...
  navigate() {
    this.navCtrl.push(InfoFeirasPage, this.infoFeira);
  }

  loadFeiras(){
    this.services.listarFeiras().subscribe(
      data => {
  ...
  addInfoWindow(marker, content, data){
    ...
    google.maps.event.addListener(marker, 'click', () => {
      ...
      this.zone.run(()=> this.infoFeira = data);
    });
